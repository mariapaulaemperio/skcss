            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <?php 
                        include '../db.php';
                        $d = $db->selectWithWhere('documents','*');
                        
                        foreach($d as $document){
                           
                        ?>
                      <tr>
                        <th scope="row" class="col"><?php echo $document['DocumentID'] ?></th>
                         <td scope="row" class="col"><?php echo $document['DocumentName'] ?>.pdf</td>
                         <td scope="row" class="col"><?php echo $document['DocumentName'] ?></td>
                         <td scope="row" class="col"><?php echo $document['DocumentDescription'] ?></td>
                         <td scope="row" class="col crud-icons">
                           
                            <a href="delete.php?Did=<?php echo $document['DocumentID'] ?>" class="btn btn-danger btn-sm" data-bs-toggle="tooltip" title="Delete">
                                <i class="fas fa-trash"></i>
                            </a>
                           
                            <a class="btn btn-success btn-sm" href="download.php?id=<?php echo $document['DocumentID'] ?>" data-bs-toggle="tooltip" title="Download">
