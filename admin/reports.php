    ...
    <div class="d-flex" id="w">
        ...
        <div class="bg-white" id="sw">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="../admin/Dashboard" class="list-group-item list-group-item-action bg-transparent second-text"><i
                        class="fa-solid fa-house"></i>Dashboard</a>
                <a href="../admin/profile" class="list-group-item list-group-item-action bg-transparent second-text"><i
                        class="fa-solid fa-user me-2"></i>Officials</a>
                <a href="../admin/Document" class="list-group-item list-group-item-action bg-transparent second-text"><i
                        class="fa-solid fa-file me-2"></i>Documents</a>
                <a href="../admin/events" class="list-group-item list-group-item-action bg-transparent second-text"><i
                        class="fa-solid fa-calendar-days me-2"></i>Events</a>
                <a href="../admin/reports" class="list-group-item list-group-item-action bg-transparent second-text ac"><i
