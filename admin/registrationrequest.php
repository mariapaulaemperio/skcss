                    ...
                    <tbody id="announcementTableBody">
                        ...
                        <td><?php echo $p['gender'] ?></td>
                            ...
                            <td style="max-width: 200px;">
                                <div class="client">
                                    <small style="word-wrap: break-word;"><?php echo $p['age'] ?></small>
                                </div>
                            </td>
                            <td>
                            <?php echo $p['birthdate'] ?>
                            </td>
                            
                            <td>
                                <a href="insert.php?idp=<?php echo $p['ID']?>" class="btn btn-primary icon-button1" >
                                    <i class="fas fa-plus"></i>
                                </a>
                                <a href="delete.php?idp=<?php echo $p['ID'] ?>" class="btn btn-danger btn-sm" data-bs-toggle="tooltip" title="Delete">
