...
<body class="bg-gray-100">
    ...
    <?php
        ...
        $users = $db->selectWithWhere('users', '*', 'email= "' . $_SESSION['email'] . '"')[0];
        extract($users);
        ?>
        <!-- ===== ===== User Main-Profile ===== ===== -->
        <section class="userProfile bg-white shadow-md p-4 rounded-lg mt-4">
            ...
            <div class="username">
                <h1 class="name text-3xl font-bold  text-gray-900" id="Username"><?php echo $firstname . " " . $lastname ?></h1>
                <div class="map flex items-center mt-3">
                    <i class="ri-map-pin-fill ri text-xl text-gray-900"></i>
                    <span class="ml-2 text-gray-600"><?php echo $address ?></span>
                </div>
            </div>

            <div class="mt-4">
            <form action="upload.php" method="post" enctype="multipart/form-data">
                <label for="image" class="text-gray-700 cursor-pointer">
            ...
            <div class="contact_Info mt-4">
                ...
                <ul class="mt-2">
                    ...
                    <li class="fullname flex items-center">
                        ...
                        <span class="info ml-2 text-gray-600"><?php echo $users['firstname'] . " " . $users['middlename'] . " " . $users['lastname']; ?></span>
                    </li>
                    ...
                    <li class="address flex items-center mt-2">
                        ...
                        <span class="info ml-2 text-gray-600"><?php echo $users['address'] ?></span>
                    </li>

                    <li class="email flex items-center mt-2">
                        <h1 class="label text-xl font-semibold text-gray-900">E-mail:</h1>
                        <span class="info ml-2 text-gray-600"><?php echo $users['email'] ?></span>
                    </li>
            ...
            <div class="basic_info mt-4">
                ...
                <ul class="mt-2">
                    <li class="birthday flex items-center">
                        ...
                        <span class="info ml-2 text-gray-600"><?php $date = $users['birthdate'];
                                                                $desiredDate = new DateTime("$date");
                                                                echo $desiredDate->format('M d, Y');  ?></span>
                    </li>

                    <li class="sex flex items-center mt-2">
                        <h1 class="label text-xl font-semibold text-gray-900">Gender:</h1>
                        <span class="info ml-2 text-gray-600"><?php echo $users['gender'] ?></span>
                    </li>
                    <li class="sex flex items-center mt-2">
                        <h1 class="label text-xl font-semibold text-gray-900">Age:</h1>
                        <span class="info ml-2 text-gray-600"><?php echo $users['age'] ?></span>
                    </li>
                </ul>
            </div>
        </section>
