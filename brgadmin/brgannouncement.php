	...
	<div class="d-flex" id="w">
        ...
        <div class="bg-white" id="sw">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="brgDashboard" class="list-group-item list-group-item-action bg-transparent second-text  fw-bold"><i class="fa-solid fa-house"></i>Dashboard</a>
                ...
                <a href="brgrequesteddocs" class="list-group-item list-group-item-action bg-transparent second-text ac"><i class="fa-solid fa-user me-2"></i></i>Document</a>
